    ...
    * {
    ...
    <body>
      ...
      if(isset($_POST["modifications"])) {
        $description=$_POST["modifications"];
        require_once("db.php");
        $sql="UPDATE `mealrequest`
        SET `Description` = '$description' WHERE `RID` =". $_SESSION["rid"];
      ...
      if(isset($_GET['rid'])) {
         ...
         $_SESSION["rid"] = $rid;
          ...
          $sql="SELECT `RID`, `RName`, `RequestStatus`, `FirstName`, `LastName`, `RequestDate` FROM `mealrequest`
          INNER JOIN `user`
        ...
        echo "<div id='title2'><h1 id='title'>Chef Modifications</h1></div>
        <div id='body'>
          <div class='row'>
              <div class='column'>
                  <div class='section1'>
                  ...
                  <form method='post' action='".$_SERVER['PHP_SELF']."'>
                      ...
                      <div class='content'>
                        <label class='label1'>Are there any modifications you want? </label></br>
                        <textarea id='modifications' name='modifications' rows='4' cols='70'></textarea>
                      </div>
