...
<?php
    ...
    $today = Date("Y/m/d");
    $sql = "INSERT INTO review (CMID, StarRating, ReviewTitle, ReviewDescription, DateOfReview, CID) VALUES ($cmid, '$star', '$rTitle', '$rDez', '$today', $cid)";
    $result = $mydb->query($sql);
?>
<!DOCTYPE html>
<html>
    ...
    <body>
    <div id="title2"><h2 id="title">REVIEW CONFIRMATION</h2></div>
    <div id="body"> 
